...
\author{\IEEEauthorblockN{Akshaan Kakar, Alex Berard}
...
Since the advent of algorithmic trading, a variety of trading platforms have been developed. These platforms offer a wide variety of backtesting capabilities

\section{System Overview}
the main objectives in our implementation were to keep the platform dataset agnostic and easily extendible. In order to achieve these goals, we partitioned the system into independently functioning subsystems which we then integrated to realize the final backtesting engine. These systems are described in detail in the following subsections.
