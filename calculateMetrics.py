...
for filename in os.listdir('quantquote_daily_sp500_83986/profits'):
	returns = []
	print filename
	with open("quantquote_daily_sp500_83986/profits/" + filename, "r") as myfile:	
	...
	with open('json/metrics/' + code.upper() + ".json", 'w') as outfile:
